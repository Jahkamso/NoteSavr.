...
function CreateArea(props) {
    ...
    return (
        <div>
            <form
                style={{ backgroundColor: props.toggleMode ? '' : '#112B3C' }}
                className="relative shadow-lg tablet:max-w-lg mt-8 mr-auto mb-5 ml-auto bg-white p-4 rounded-md mobile:w-11/12"
            >
                <input
                    style={{
                        backgroundColor: props.toggleMode ? '' : '#112B3C',
                        color: props.toggleMode ? '' : '#ECF2FF',
                    }}
